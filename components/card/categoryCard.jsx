...
export default function CategoryCard({ title, image, slug }) {
  return (
    <Link href={"/categories/" + slug}>
      <div className="cursor-pointer p-2 hover:scale-[1.03] active:scale-100 hover:text-primary border-[1px] rounded-[5px] smooth-transition grid place-items-center my-2">
