...
export default function Footer() {
  ...
  const paymentLogo = [stripe, mastercard, paypal, gpay, visa];
      ...
      <Grid {...itemsProps}>
        <div>
          ...
          <p className="max-w-[20ch] my-4">
            ...
            tempora reiciendis debitis consectetur accusamus quod dolores error
            maiores doloribus omnis!
          </p>
          {/* icon */}
          <Stack direction="row" spacing={1}>
            {paymentLogo.map((src, index) => (
              <Image
                ...
                height={30}
                alt="payment-logo"
                className="w-[40px] h-[30px] p-1 rounded-sm bg-white"
              />
            ))}
          </Stack>
        </div>
